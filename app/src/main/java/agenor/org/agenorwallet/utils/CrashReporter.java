...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final AgenorApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (AgenorContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + AgenorContext.NETWORK_PARAMETERS.getId() + "\n");



		final MultiWallet multiWallet = ((AgenorModuleImp)application.getModule()).getWallet();

		report.append("############ AGE WALLET ########################");
		addWalletInformation(multiWallet.getPivWallet(), report);
		report.append("############ ZAGE WALLET ########################");
