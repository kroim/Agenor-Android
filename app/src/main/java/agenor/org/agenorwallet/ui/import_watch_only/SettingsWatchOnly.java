package agenor.org.agenorwallet.ui.import_watch_only;
...
import agenor.org.agenorwallet.ui.base.dialogs.DialogListener;
import agenor.org.agenorwallet.ui.base.dialogs.SimpleTextDialog;
import agenor.org.agenorwallet.utils.DialogsUtil;

import static agenor.org.agenorwallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                agenorModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_AGE
                );
