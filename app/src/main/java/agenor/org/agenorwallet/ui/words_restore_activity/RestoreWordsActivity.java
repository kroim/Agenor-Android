package agenor.org.agenorwallet.ui.words_restore_activity;
...
import static agenor.org.agenorwallet.module.AgenorContext.Agenor_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        try {
            mnemonicWords = agenorModule.getAvailableMnemonicWordsList();
            mnemonicAdapter = new ArrayAdapter<>(this, android.R.layout.select_dialog_item, mnemonicWords);
        }catch (NullPointerException e){
            Toast.makeText(this, "Your device does not support Mnemonic module.", Toast.LENGTH_SHORT).show();
            mnemonicWords = new ArrayList<String>();
            mnemonicAdapter = new ArrayAdapter<>(this, android.R.layout.select_dialog_item, mnemonicWords);
        }
    }
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            agenorModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            agenorModule.restoreWallet(mnemonic, Agenor_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (agenorApplication.getAppConf().getPincode() != null){
                                                        ...
                                                        if(!agenorApplication.getAppConf().isAppInit()){
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, AgenorContext.ENABLE_BIP44_APP_VERSION));
