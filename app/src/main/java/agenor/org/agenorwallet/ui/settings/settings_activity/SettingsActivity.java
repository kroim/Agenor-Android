package agenor.org.agenorwallet.ui.settings.settings_activity;
...
import agenor.org.agenorwallet.ui.export_account.ExportKeyActivity;
import agenor.org.agenorwallet.ui.import_watch_only.SettingsWatchOnly;
...
import agenor.org.agenorwallet.ui.settings.settings_network_activity.SettingsNetworkActivity;
import agenor.org.agenorwallet.ui.settings.settings_pincode_activity.SettingsPincodeActivity;
import agenor.org.agenorwallet.ui.settings.settings_rates.SettingsRatesActivity;
import agenor.org.agenorwallet.ui.start_node_activity.StartNodeActivity;
import agenor.org.agenorwallet.ui.tutorial_activity.TutorialActivity;
import agenor.org.agenorwallet.utils.AndroidUtils;
import agenor.org.agenorwallet.utils.CrashReporter;
import agenor.org.agenorwallet.utils.DialogsUtil;
import agenor.org.agenorwallet.utils.IntentsUtils;
import agenor.org.agenorwallet.utils.NavigationUtils;
import agenor.org.agenorwallet.utils.ReportIssueDialogBuilder;

import static agenor.org.agenorwallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#5c4c7c>GreatStar</font> <br>Agenor Community © 2021";
        ...
        text_rates.setText(agenorApplication.getAppConf().getSelectedRateCoin());
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#5c4c7c>"+agenorModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Block Height<br><font color=#5c4c7c>"+agenorModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#5c4c7c>"+
                                agenorModule.getProtocolVersion()+"</font>"
    ...
    private void launchRollbackBlockchainTo() {
        ...
        dialog.setListener(new SimpleEditDialogFragment.SimpleTwoBtnsDialogListener() {
            ...
            public void onRightBtnClicked(SimpleEditDialogFragment dialog) {
                ...
                agenorApplication.stopBlockchainAndRollBackitTo(height);
                dialog.dismiss();
    ...
    private void launchReportDialog(boolean isInternalReport) {
        ...
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "agenor.org.agenorwallet.agenorwallet.myfileprovider",
            ...
            protected CharSequence subject() {
                return AgenorContext.REPORT_SUBJECT_ISSUE+" "+agenorApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, agenorApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                MultiWallet multiWallet = ((AgenorModuleImp)agenorApplication.getModule()).getWallet();
