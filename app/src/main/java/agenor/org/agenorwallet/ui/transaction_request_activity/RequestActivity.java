package agenor.org.agenorwallet.ui.transaction_request_activity;
...
import agenor.org.agenorwallet.ui.transaction_send_activity.AmountInputFragment;
import agenor.org.agenorwallet.utils.DialogsUtil;
import agenor.org.agenorwallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static agenor.org.agenorwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = agenorModule.getFreshNewAddress().toBase58();

        NetworkParameters params = agenorModule.getConf().getNetworkParams();

        String agenorURI = AgenorURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(agenorURI);
        qrDialog.setQrText(agenorURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String agenorURI) throws WriterException {
