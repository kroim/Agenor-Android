package agenor.org.agenorwallet.ui.export_account;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = agenorModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(AgenorContext.NETWORK_PARAMETERS);
