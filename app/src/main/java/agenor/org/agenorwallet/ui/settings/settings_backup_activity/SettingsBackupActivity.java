package agenor.org.agenorwallet.ui.settings.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = agenorModule.backupWallet(backupFile, firstPassword);

            if (result){
                agenorApplication.getAppConf().setHasBackup(true);
