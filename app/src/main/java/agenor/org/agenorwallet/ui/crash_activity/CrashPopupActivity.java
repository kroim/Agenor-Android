package agenor.org.agenorwallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "agenor.org.agenorwallet.agenorwallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        agenorApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ agenorApplication.getVersionName();
    }
