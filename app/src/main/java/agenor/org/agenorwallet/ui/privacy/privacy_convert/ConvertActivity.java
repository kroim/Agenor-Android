package agenor.org.agenorwallet.ui.privacy.privacy_convert;
...
public class ConvertActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        View headerView = getLayoutInflater().inflate(R.layout.fragment_agenor_amount, header_container);
        ...
        btn_convert.setOnClickListener(v -> {
            ...
            try {
                ...
                // Check if it's a mint or a spend to re convert them to AGE
        ...
        btn_add_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                edit_amount.setText(agenorModule.getZpivAvailableBalanceCoin().toPlainString());
            }
        });
        ...
        edit_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    ...
                    if (agenorRate != null)
                        txt_amount_local.setText("0 "+agenorRate.getCode());
                    else
                        txt_amount_local.setText(R.string.no_rate);
                }
            }
    ...
    private void reconvertProcess(Coin coin) throws InsufficientMoneyException {
        // Internal address to receive the AGE
        Address address = agenorModule.getReceiveAddress();
        SendRequest sendRequest = agenorModule.createSpend(address, coin, true);
        SimpleTwoButtonsDialog simpleTwoButtonsDialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                this,
                "zAGE Spend",
                String.format("You are just about to convert %s zAGE to AGE again\n\nThis may take some time", coin.toPlainString()),
    ...
    private void mintProcess(Coin coin) throws InsufficientMoneyException {
        final SendRequest sendRequest = agenorModule.createMint(coin);
        DialogsUtil.buildSimpleTwoBtnsDialog(
                this,
                "Mint process",
                String.format("You are just about to convert %s to zAGE", coin.toFriendlyString()),
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    @Override
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        new Thread(() -> {
                            ...
                            try {
                                ...
                                agenorModule.commitTx(tx);
                                Intent intent = new Intent(ConvertActivity.this, AgenorWalletService.class);
