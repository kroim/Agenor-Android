...
public class CoinMarketCapApiClient {
    ...
    public class AgenorMarket{
        ...
        public AgenorMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public AgenorMarket getAgenorPxrice() throws RequestAgenorRateException{
        try {
            AgenorMarket agenorMarket = null;
            String url = this.URL + "ticker/agenor/";
            ...
            e.printStackTrace();
            throw new RequestAgenorRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestAgenorRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestAgenorRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestAgenorRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
