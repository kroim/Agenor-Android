...
public class AgenorContext {
    ...
    /** Agenor wallet released time */
    public static final long Agenor_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1500940800;

    /** Currency exchange rate */
    public static final String URL_FIAT_CURRENCIES_RATE = "https://bitpay.com/rates";

    // report mail
    public static final String REPORT_EMAIL = "furszy@agenor.org";
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "agenor-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
