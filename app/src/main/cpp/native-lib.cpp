...
Java_agenor_org_agenorwallet_AndroidJniBridge_compute1024seedNative(JNIEnv *env, jobject instance,
                                                                jbyteArray seed) {
    try{
...
Java_agenor_org_agenorwallet_AndroidJniBridge_computeVSeedAndVExpandedNative(JNIEnv *env,
                                                                         jobject instance) {
